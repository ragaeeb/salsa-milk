...
- Prefer `pytest` for running the automated test suite; invoke `pytest --maxfail=1 --disable-warnings` during development after installing dev dependencies with `uv pip install -r requirements_dev.txt`.
